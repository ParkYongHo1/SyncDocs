...
export const WelcomeSection = () => {
  return (
    <div className="px-12 py-12 flex flex-col items-start max-w-4xl mx-auto w-full">
      ...
      <p className="text-[16px] text-gray-400 leading-relaxed mb-8 w-full">
      ...
      <div className="w-full rounded-2xl border border-[#232323] bg-[#141414] p-7">
